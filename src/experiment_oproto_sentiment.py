...
class RunExperiment:
    ...
    def run_training_epoch(self, params, train_dl, optimizer, epoch):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(state, open(os.path.join(RSL_PATH, 'oproto_sentiment_k100_%s.pth'%epoch), 'wb'))
    ...
    def project_data(self, idx_, dev_dl, idx2word, epoch, str_):
        ...
        RSL_PATH= HOME_DIR+'/encodeds/oproto'
        ...
        with torch.no_grad():
            ...
            for i, dat in enumerate(dev_dl):
                ...
                for j, sdat in enumerate(dat):
                    ...
                    save_pickle(RSL_PATH, 'encoded_sent_oproto_k100_%s_%s_%s_%s_%s.pkl'%(str_, epoch, idx_, i, j), (dataset, encodeds))
    ...
    def project_data_continue(self, i, dat, domain, idx2word, epoch, str_):
        ...
        with torch.no_grad():
            ...
            save_pickle(RSL_PATH, 'encoded_sent_oproto_k100_%s_%s_0_%s.pkl'%(str_, epoch, i), (domain, encodeds))
