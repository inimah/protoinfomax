...
class workspace:
    ...
    def __init__(self, workspace_name, params, role):
        ...
        self.flatten_supporting_sets_test = None
        ...
        if self.role == 'train_workspace':
            ...
            #print("len self.labels_in_train:", len(self.labels_in_train))
            #print("len self.train_intent2ids_list:", len(self.train_intent2ids_list))
