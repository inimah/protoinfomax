...
class GRUEncoder(nn.Module):
    ...
    def forward(self, x_sup, x_sup_len, y_sup, y_sup_oh, x_q, x_q_len, y_q, y_q_oh, x_neg, x_neg_len, y_neg, y_neg_oh):
        ...
        y_q_oh = torch.cat((y_q_oh, y_q_oh, y_q_oh, y_q_oh, y_q_oh, y_q_oh, y_q_oh, y_q_oh, y_q_oh, y_q_oh), dim=0)
